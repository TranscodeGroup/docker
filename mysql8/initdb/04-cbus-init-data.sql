...
-- ----------------------------
INSERT INTO `cbus`.`basic_device_type` (`id`, `type_id`, `type_name`, `factory`, `protocol`, `support`, `img_url`, `sort_id`, `remark`, `tags`, `notice`, `two_in_one`, `alarm_mapping`, `create_time`, `update_time`) VALUES (1, 'DTY000113', 'TG-MDVR', 'Transcodegroup', '808&1078', 3568, 'files/img/devtype/4be52d46ecf84d79b10de8f7c3e2b230.jpg', 41, '支持国标808/1078设备，通用类型', 'k3u;k8vu;stu;zip;k8u', 2, 0, NULL, '2019-08-23 07:43:12', '2025-12-23 03:16:32');
INSERT INTO `cbus`.`basic_device_type` (`id`, `type_id`, `type_name`, `factory`, `protocol`, `support`, `img_url`, `sort_id`, `remark`, `tags`, `notice`, `two_in_one`, `alarm_mapping`, `create_time`, `update_time`) VALUES (2, 'DTY000124', 'K3&MDVR', 'Transcodegroup', '808&1078&bus', 69104, '', 61, 'K3&MDVR配套使用', 'k3u;k8vu;stu;zip', 2, 1, NULL, '2020-12-17 07:25:54', '2025-12-23 03:16:33');
INSERT INTO `cbus`.`basic_device_type` (`id`, `type_id`, `type_name`, `factory`, `protocol`, `support`, `img_url`, `sort_id`, `remark`, `tags`, `notice`, `two_in_one`, `alarm_mapping`, `create_time`, `update_time`) VALUES (3, 'DTY000125', 'TG_BUS', 'STM', '808&1078&bus&stm', 2048, '', 71, '扩展协议，0x16,0x17,0x18是公交数据的设备,GPS站序错误忽略\n', 'sw;zip;k8u', 2, 0, NULL, '2020-12-24 11:36:04', '2025-12-23 03:16:33');
INSERT INTO `cbus`.`basic_device_type` (`id`, `type_id`, `type_name`, `factory`, `protocol`, `support`, `img_url`, `sort_id`, `remark`, `tags`, `notice`, `two_in_one`, `alarm_mapping`, `create_time`, `update_time`) VALUES (4, 'DTY000126', 'TG-K3', 'Transcodegroup', '808&1078&bus2016-sf', 3504, '', 72, '刷卡，报站，文本下发', 'k3u;stu;zip', 2, 0, NULL, '2021-01-25 05:41:52', '2025-12-23 03:16:34');
INSERT INTO `cbus`.`basic_device_type` (`id`, `type_id`, `type_name`, `factory`, `protocol`, `support`, `img_url`, `sort_id`, `remark`, `tags`, `notice`, `two_in_one`, `alarm_mapping`, `create_time`, `update_time`) VALUES (5, 'DTY000127', 'L12', 'L12', 'LTY', 68720, '', NULL, 'lty的设备升级', 'sw', 101, 0, NULL, '2021-06-02 07:23:52', '2025-12-23 03:16:35');
INSERT INTO `cbus`.`basic_device_type` (`id`, `type_id`, `type_name`, `factory`, `protocol`, `support`, `img_url`, `sort_id`, `remark`, `tags`, `notice`, `two_in_one`, `alarm_mapping`, `create_time`, `update_time`) VALUES (6, 'DTY010001', 'K3-TALK&MDVR', '三锋智能', '808-2013&1078-2016&bus2016-sf&safety-jiangsu', 69104, '', 100, 'K3+通力设备，K3对讲， 必须包含关键字 （K3-TALK）', 'k3u;k8vu;stu;zip', 2, 1, '{}', '2024-01-11 06:04:13', '2025-12-23 03:16:37');
