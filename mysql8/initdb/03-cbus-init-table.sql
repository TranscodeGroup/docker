...
CREATE TABLE `basic_device_type`  (
  ...
  `protocol` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '通讯协议类型',
...
CREATE TABLE `ledger_daily_car`  (
  ...
  INDEX `idx_date_car`(`company_id` ASC, `is_deleted` ASC, `work_date` ASC, `car_id` ASC) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `ledger_daily_employee`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_date_route`(`company_id` ASC, `work_date` ASC, `route_id` ASC, `is_deleted` ASC) USING BTREE,
  INDEX `idx_date_emp`(`company_id` ASC, `is_deleted` ASC, `work_date` ASC, `emp_id` ASC) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `system_av_rtp`  (
  `id` int NOT NULL AUTO_INCREMENT,
  `company_id` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '企业id',
  `node_id` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `system_module`  (
  ...
  `icon` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'al-icon-genderless' COMMENT '图标',
  `path` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT 'url路径',
