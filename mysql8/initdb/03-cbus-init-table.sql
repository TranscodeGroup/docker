...
CREATE TABLE `device_alarm`  (
  ...
  `route_id` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '线路ID',
  `route_name` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '线路名称',
  `alarm_id` int NULL DEFAULT 0 COMMENT '删除，采用下面字段',
  `device_alarm_id` int NULL DEFAULT NULL,
  `platform_alarm_id` int NULL DEFAULT NULL COMMENT '对应平台报警ID',
  `lat` decimal(10, 6) NULL DEFAULT NULL COMMENT '纬度，一般指北纬',
  `lng` decimal(10, 6) NULL DEFAULT NULL COMMENT '经度，一般指东经',
  `speed` int NULL DEFAULT 0 COMMENT '速度，1/10km',
  `angle` int NULL DEFAULT 0 COMMENT '方向角，0是正北，360度',
  `height` int NULL DEFAULT 0 COMMENT '海拔',
  `state` int NULL DEFAULT 0 COMMENT '状态',
  `event_time` datetime NOT NULL COMMENT '事件时间',
  `is_readed` int NULL DEFAULT 0 COMMENT '读取状态，0未读',
  ...
  INDEX `idx_car_time`(`company_id` ASC, `car_id` ASC, `event_time` ASC) USING BTREE,
  INDEX `idx_route_time`(`company_id` ASC, `route_id` ASC, `event_time` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 10 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = DYNAMIC PARTITION BY RANGE (to_days(`event_time`))
PARTITIONS 44
...
CREATE TABLE `device_alarm_file`  (
  `id` int NOT NULL AUTO_INCREMENT COMMENT '设备最新版本信息',
  `company_id` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '企业',
  `imei` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '设备id',
  ...
  `update_time` datetime NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_alarm_key`(`company_id` ASC, `alarm_key` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `device_alarm_safety`  (
  ...
  `alarm_id` int NOT NULL DEFAULT 0 COMMENT '报警自增ID',
  ...
  INDEX `idx_route_time`(`company_id` ASC, `route_id` ASC, `event_time` ASC) USING BTREE,
  INDEX `idx_time`(`company_id` ASC, `event_time` ASC) USING BTREE,
  INDEX `idx_work_date`(`company_id` ASC, `work_date` ASC, `route_id` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `device_card`  (
  ...
  `check_in` smallint NULL DEFAULT NULL COMMENT '0签退 1签到',
  `is_valid` smallint NULL DEFAULT NULL COMMENT '0非法 1合法',
  ...
  `update_time` datetime NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_card_time`(`company_id` ASC, `car_id` ASC, `event_time` ASC) USING BTREE,
  INDEX `idx_time`(`company_id` ASC, `event_time` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `device_cmd_request`  (
  ...
  `car_id` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '车辆ID',
  `car_name` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '车辆名称',
  `route_code` int NOT NULL COMMENT '线路编号',
  ...
  `update_time` datetime NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_card`(`imei` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `device_connect`  (
  ...
  `route_name` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '线路名称',
  `connect_flag` int NOT NULL DEFAULT 0 COMMENT '0断开连接 1建立连接 ',
  ...
  `update_time` datetime NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_route_time`(`company_id` ASC, `route_id` ASC, `connect_time` ASC) USING BTREE,
  INDEX `idx_car_time`(`company_id` ASC, `car_id` ASC, `connect_time` ASC) USING BTREE,
  INDEX `idx_time`(`company_id` ASC, `connect_time` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 3 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `device_depart_arrive`  (
  ...
  `route_id` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '线路id',
  `route_name` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '线路名称',
  `flag` smallint NOT NULL DEFAULT 10 COMMENT '1到站 2离站',
  `route_code` int NOT NULL DEFAULT 0 COMMENT '运行线路编号',
  `direction` smallint NOT NULL DEFAULT 0 COMMENT '方向 1下行 2上行',
  `serial` smallint NOT NULL COMMENT '车站序号 上下行从1开始',
  ...
  `station_flag` smallint NULL DEFAULT 0 COMMENT '0中间站 1起点 255终点',
  ...
  `state` int NULL DEFAULT NULL COMMENT '标志字段',
  `lat` decimal(11, 6) NULL DEFAULT NULL COMMENT '纬度',
  `lng` decimal(11, 6) NULL DEFAULT NULL COMMENT '经度',
  ...
  `passenger` smallint NULL DEFAULT NULL COMMENT '车厢内人数',
  `event_time` datetime NOT NULL COMMENT '事件时间',
  `receive_time` datetime NULL DEFAULT CURRENT_TIMESTAMP COMMENT '接收时间',
  ...
  `expected_duration` int NULL DEFAULT NULL COMMENT '预期从起点耗时,秒',
  `actual_duration` int NULL DEFAULT NULL COMMENT '实际从起点耗时,秒',
  ...
  INDEX `idx_time`(`company_id` ASC, `event_time` ASC) USING BTREE,
  INDEX `idx_car_time`(`company_id` ASC, `car_id` ASC, `event_time` ASC) USING BTREE,
  INDEX `idx_route_time`(`company_id` ASC, `route_code` ASC, `event_time` ASC) USING BTREE
...
CREATE TABLE `device_display`  (
  ...
  `warning` int NULL DEFAULT NULL COMMENT '报警',
  ...
  `update_time` datetime NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
  PRIMARY KEY (`id`, `event_time`) USING BTREE,
  INDEX `ix_imei_time`(`display_id` ASC, `event_time` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `device_file_upload`  (
  `id` int UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '文件上传id',
  `company_id` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '企业',
  ...
  `wlan` smallint NULL DEFAULT 0 COMMENT '下载条件',
  `size` int NULL DEFAULT 0 COMMENT '文件大小',
  `upload_state` smallint NOT NULL DEFAULT 0 COMMENT '-1 取消 0等待执行 1下载中 2完成 3失败',
  `request_origin` int NOT NULL DEFAULT 0 COMMENT '数据来源 0平台指令 1SOS',
  `request_state` smallint NOT NULL DEFAULT 0 COMMENT '0执行中 1暂停 2继续 3取消',
  ...
  `serial` int NULL DEFAULT 0 COMMENT '应答流水号',
  `remark` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '备注信息',
  ...
  `update_time` datetime NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_file_upload`(`company_id` ASC, `start_time` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `device_illegal`  (
  `id` int NOT NULL AUTO_INCREMENT COMMENT '设备违规报警',
  `company_id` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '企业',
  ...
  `route_name` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '线路名称',
  `route_code` int NULL DEFAULT NULL COMMENT '线路编码',
  `illegal_flag` int NOT NULL DEFAULT 0 COMMENT '预留，0开始 1结束',
  ...
  `illegal_value` int NULL DEFAULT NULL,
  `standard_value` int NULL DEFAULT NULL,
  `lat` decimal(10, 6) NULL DEFAULT NULL COMMENT '纬度，一般指北纬',
  `lng` decimal(10, 6) NULL DEFAULT NULL COMMENT '经度，一般指东经',
  `speed` int NULL DEFAULT 0 COMMENT '速度，1/10km',
  `azimuth` int NULL DEFAULT 0 COMMENT '方向角，0是正北，360度',
  `height` int NULL DEFAULT 0 COMMENT '海拔',
  `make_up` int NULL DEFAULT 0 COMMENT '状态',
  `event_time` datetime NULL DEFAULT NULL COMMENT '事件时间',
  `attachment` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `station_id` int NULL DEFAULT NULL COMMENT '站点表ID',
  `station_name` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '站点名称',
  ...
  INDEX `idx_car_time`(`company_id` ASC, `car_id` ASC, `event_time` ASC) USING BTREE,
  INDEX `idx_time`(`company_id` ASC, `event_time` ASC) USING BTREE,
  INDEX `device_illegal_company_id_IDX`(`company_id` ASC, `work_date` ASC, `route_id` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `device_over_speed`  (
  ...
  `route_id` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '线路id',
  `route_name` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '线路名称',
  `over_type` int NOT NULL DEFAULT 0 COMMENT '0开始超速 1结束超速',
  `start_state` int NULL DEFAULT NULL COMMENT '开始超速的状态',
  `start_time` datetime NULL DEFAULT NULL COMMENT '起点时间',
  `start_station_id` int NULL DEFAULT NULL COMMENT '开始超速的站点ID',
  `start_station_name` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '开始超速的站点名称',
  ...
  `end_state` int NULL DEFAULT NULL COMMENT '结束超速的状态',
  `end_time` datetime NULL DEFAULT NULL COMMENT '终点时间',
  `end_station_id` int NULL DEFAULT NULL COMMENT '结束超速的站点ID',
  `end_station_name` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '结束超速的站点名称',
  ...
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_time`(`company_id` ASC, `start_time` ASC) USING BTREE,
  INDEX `idx_route_time`(`company_id` ASC, `route_id` ASC, `start_time` ASC) USING BTREE,
  INDEX `idx_car_time`(`company_id` ASC, `car_id` ASC, `start_time` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `device_passenger`  (
  ...
  `route_code` int NULL DEFAULT 0 COMMENT '运行线路编号',
  `direction` smallint NULL DEFAULT NULL COMMENT '方向',
  ...
  `update_time` datetime NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_route_time`(`company_id` ASC, `route_code` ASC, `upload_time` ASC) USING BTREE,
  INDEX `idx_stop_time`(`company_id` ASC, `stop_id` ASC, `upload_time` ASC) USING BTREE,
  INDEX `idx_time`(`company_id` ASC, `upload_time` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `device_poi`  (
  ...
  `flag` smallint NOT NULL DEFAULT 0 COMMENT '1到站 2离站',
  `route_id` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `route_name` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '线路名称',
  `station_id` bigint NULL DEFAULT NULL COMMENT '对应站点表的唯一ID',
  `station_flag` smallint NOT NULL DEFAULT 0 COMMENT '0中间站 1起点 255终点',
  `lat` decimal(11, 6) NULL DEFAULT NULL COMMENT '纬度',
  `lng` decimal(11, 6) NULL DEFAULT NULL COMMENT '经度',
  `mileage` decimal(11, 3) NULL DEFAULT NULL COMMENT '里程 km',
  `up_number` int NULL DEFAULT 0 COMMENT '上车人数',
  `down_number` int NULL DEFAULT 0 COMMENT '下车人数',
  `passenger` int NULL DEFAULT 0 COMMENT '车厢内人数',
  `passenger1` int NULL DEFAULT 0 COMMENT '画面1客流',
  `passenger2` int NULL DEFAULT 0 COMMENT '画面2客流',
  `passenger3` int NULL DEFAULT 0 COMMENT '画面3客流',
  `operating_status` smallint NULL DEFAULT 0 COMMENT '操作员审核状态0未审核 1审核',
  `event_time` datetime NOT NULL COMMENT '事件时间',
  `change_type` smallint NULL DEFAULT 0 COMMENT '10起点 20进站  30行驶 40静止 100站序变化 ',
  `create_time` datetime NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建日期',
  `update_time` datetime NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_car_time`(`company_id` ASC, `car_id` ASC, `event_time` ASC) USING BTREE,
...
CREATE TABLE `device_position`  (
  ...
  INDEX `idx_time`(`company_id` ASC, `event_time` ASC) USING BTREE,
  INDEX `idx_car_time`(`company_id` ASC, `car_id` ASC, `event_time` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 120 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = DYNAMIC PARTITION BY RANGE (to_days(`event_time`))
PARTITIONS 49
(PARTITION `p_201912` VALUES LESS THAN (737790) ENGINE = InnoDB MAX_ROWS = 0 MIN_ROWS = 0 ,
PARTITION `p_202001` VALUES LESS THAN (737821) ENGINE = InnoDB MAX_ROWS = 0 MIN_ROWS = 0 ,
PARTITION `p_202002` VALUES LESS THAN (737850) ENGINE = InnoDB MAX_ROWS = 0 MIN_ROWS = 0 ,
...
CREATE TABLE `device_region`  (
  ...
  `route_name` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '线路名称',
  `route_code` int NULL DEFAULT NULL COMMENT '线路编号',
  `event_type` int NULL DEFAULT NULL COMMENT '1:进；2:出',
  `business_type` int NULL DEFAULT NULL COMMENT '业务类型 见表13',
  `region_code` int NULL DEFAULT NULL COMMENT '定点编号',
  ...
  `flag_field` int NULL DEFAULT NULL COMMENT '表23 标志字段定义 ',
  `lng` decimal(11, 6) NULL DEFAULT NULL COMMENT '经度',
  `lat` decimal(11, 6) NULL DEFAULT NULL COMMENT '纬度',
  `height` smallint NULL DEFAULT NULL COMMENT '高度',
  `speed` smallint NULL DEFAULT NULL COMMENT '速度',
  `azimuth` smallint NULL DEFAULT NULL COMMENT '方位角',
  `event_time` datetime NOT NULL COMMENT '事件时间',
  `use_type` smallint NULL DEFAULT 0 COMMENT '区域用途，0默认1停车场2加油充电站3维修点',
  `mileage` decimal(11, 3) NULL DEFAULT NULL COMMENT '里程 km',
  `receive_time` datetime NULL DEFAULT CURRENT_TIMESTAMP COMMENT '接收时间',
  `attached` varchar(256) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '附加数据',
  `create_time` datetime NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建日期',
...
CREATE TABLE `device_seat`  (
  ...
  `lng` decimal(11, 6) NULL DEFAULT NULL COMMENT '经度',
  `lat` decimal(11, 6) NULL DEFAULT NULL COMMENT '纬度',
  `seat_id` int NULL DEFAULT NULL COMMENT '安全带唯一ID',
  `seat_num` int NULL DEFAULT NULL COMMENT '座椅编号',
  `seat_state` int NULL DEFAULT NULL COMMENT ' 安全带工作状态 0=匹配状态 1=无人状态 2=有人但没系安全带 3=操作不当 4=正常 32=设置成功 40=发射板失联 80=电池电量低',
  `equipment_status` int NULL DEFAULT NULL COMMENT '安全带匹配状态 0=新增 1=更新 2=停用',
  `last_update_time` datetime NULL DEFAULT NULL COMMENT '安全带设备状态最后修改时间',
  `create_time` datetime NULL DEFAULT CURRENT_TIMESTAMP COMMENT '产生时间',
  `update_time` datetime NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_car_time`(`company_id` ASC, `car_id` ASC) USING BTREE,
...
CREATE TABLE `device_seat_last`  (
  ...
  `update_time` datetime NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `idx_imei`(`company_id` ASC, `imei` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `device_self_check`  (
  ...
  `route_id` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT '' COMMENT '线路',
  `route_name` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '线路名称',
  `rsp_serial` int NULL DEFAULT NULL COMMENT '应答流水号',
  `info_length` int NULL DEFAULT NULL COMMENT '自检信息长度',
  `record_chn_number` int NULL DEFAULT NULL COMMENT '录像通道数 ',
  `record_status` int NULL DEFAULT NULL COMMENT '录像状态 ',
  `wireless_type` int NULL DEFAULT NULL COMMENT '无限模块类型',
  `wireless_status` int NULL DEFAULT NULL COMMENT '无线模块状态',
  `gps_status` int NULL DEFAULT NULL COMMENT 'gps模块状态',
  `power_status` int NULL DEFAULT NULL COMMENT '电源状态',
  `screen_status` int NULL DEFAULT NULL COMMENT '调度屏状态',
  `storage_number` int NULL DEFAULT NULL COMMENT '存储信息列表数',
  ...
  `update_time` datetime NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_route_time`(`company_id` ASC, `route_id` ASC, `upload_time` ASC) USING BTREE,
  INDEX `idx_car_time`(`company_id` ASC, `car_id` ASC, `upload_time` ASC) USING BTREE,
  INDEX `idx_time`(`company_id` ASC, `upload_time` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `device_snap`  (
  ...
  `car_name` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '车辆名称',
  `lpn` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '车牌',
  `chn` smallint NULL DEFAULT NULL COMMENT '通道号',
  ...
  `station_id` int NULL DEFAULT NULL COMMENT '站点表唯一ID',
  `stop_id` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '站台ID',
  `media_id` int NULL DEFAULT NULL COMMENT '抓拍到的多媒体ID',
  `create_time` datetime NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建日期',
  `update_time` datetime NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_car_time`(`company_id` ASC, `car_id` ASC, `snap_time` ASC) USING BTREE,
  INDEX `idx_route_time`(`company_id` ASC, `route_id` ASC, `snap_time` ASC) USING BTREE,
  INDEX `idx_time`(`company_id` ASC, `snap_time` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `device_snap_list`  (
  `id` int NOT NULL AUTO_INCREMENT,
  `company_id` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '企业ID',
  `snap_id` int NULL DEFAULT NULL COMMENT '抓拍表ID',
  `imei` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '设备id',
  `car_id` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '车辆ID',
  `car_name` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '车辆名称',
  `lpn` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '车牌',
...
CREATE TABLE `device_version`  (
  ...
  `update_time` datetime NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_version`(`company_id` ASC, `car_id` ASC, `upload_time` ASC) USING BTREE,
  INDEX `idx_imei`(`imei` ASC, `upload_time` ASC) USING BTREE,
  INDEX `idx_time`(`company_id` ASC, `upload_time` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = DYNAMIC;
