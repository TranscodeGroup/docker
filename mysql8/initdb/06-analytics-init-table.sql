...
CREATE TABLE `passenger_daily_stop_route`  (
  ...
  `company_id` varchar(16) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '企业ID',
  `work_date` char(10) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL,
  `stop_id` varchar(16) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL DEFAULT '' COMMENT '站台编码',
  `stop_name` varchar(128) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '站台名称',
  `route_code` int NOT NULL COMMENT '线路id',
  `route_id` varchar(16) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '线路id',
...
) ENGINE = InnoDB AUTO_INCREMENT = 56223 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `passenger_period_route`  (
  `id` int NOT NULL AUTO_INCREMENT,
  `company_id` varchar(16) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '企业ID',
  `work_date` char(10) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '使用企业时区转换的日期',
  `route_id` varchar(16) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '线路id',
  `route_name` varchar(128) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '线路名称',
  `route_code` int NULL DEFAULT NULL COMMENT '线路id',
  `start_time` char(5) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '开始时间',
  `end_time` char(5) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '结束时间',
  `time_zone` varchar(16) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '时区',
  `sample_count` int UNSIGNED NOT NULL COMMENT '采样数量',
...
) ENGINE = InnoDB AUTO_INCREMENT = 38345 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `passenger_period_stop`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_stop_date`(`company_id` ASC, `stop_id` ASC, `work_date` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 600003 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci ROW_FORMAT = DYNAMIC;
...
) ENGINE = InnoDB AUTO_INCREMENT = 1228260 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `route_daily_station`  (
  `id` int NOT NULL AUTO_INCREMENT,
  `company_id` varchar(16) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '企业ID',
  `work_date` char(10) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '开始时间',
  `route_id` varchar(16) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '线路id',
  `way_id` varchar(16) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '站点方案ID',
  `direction` smallint NULL DEFAULT NULL COMMENT '方向',
  `route_code` int NULL DEFAULT NULL COMMENT '线路id',
  ...
  `stop_id` varchar(16) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '站台编码',
...
) ENGINE = InnoDB AUTO_INCREMENT = 1418255 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `route_period_speed`  (
  ...
  `sample_count` int UNSIGNED NULL DEFAULT NULL COMMENT '采样数量',
  `total_velocity` bigint UNSIGNED NULL DEFAULT NULL COMMENT '速度之和',
  `aggregate` varchar(16) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '聚合函数',
  `peak_id` smallint NOT NULL DEFAULT 0 COMMENT '0平峰 1早高峰 2晚高峰 3低峰',
  `create_time` datetime NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建日期',
  `update_time` datetime NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE,
...
) ENGINE = InnoDB AUTO_INCREMENT = 1421451 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `route_period_speed_real`  (
  `id` int NOT NULL AUTO_INCREMENT,
  `company_id` varchar(16) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '企业ID',
  `work_date` char(10) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '使用企业时区转换的日期',
  `route_code` int NULL DEFAULT NULL COMMENT '线路id',
  `direction` smallint NULL DEFAULT NULL COMMENT '方向',
