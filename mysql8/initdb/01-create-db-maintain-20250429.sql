/*
 ...
 Source Server         : 103.20.204.183_6000-distarGps-v1
 Source Server Type    : MySQL
 Source Server Version : 50718 (5.7.18)
 Source Host           : 103.20.204.183:6000
...
CREATE TABLE `device_category`  (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '产品主表',
  ...
  `product_type` int(11) NOT NULL DEFAULT 0 COMMENT '设备分类类别  0其他 100 定位设备 200视频设备 300主动安全设备 400公交报站设备',
  `order_id` int(11) NOT NULL DEFAULT 0 COMMENT '排序字段',
...
CREATE TABLE `device_manufacturer`  (
  ...
  `updated_unix` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `uk_id`(`manufacturer_id`) USING BTREE,
  UNIQUE INDEX `uk_name`(`manufacturer_name`) USING BTREE,
  UNIQUE INDEX `uk_code`(`manufacturer_code`) USING BTREE
...
CREATE TABLE `device_product`  (
  ...
  `protocol` varchar(128) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '通讯协议类型',
  `firmware_tags` varchar(128) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '固件过滤标签',
  `notice_type` smallint(6) NULL DEFAULT 0 COMMENT '1: 808控制指令升级 2: bus通过远程升级通知升级',
  `support` int(11) NULL DEFAULT 0 COMMENT '支持功能 低位 第1位在线 2定位 3ACC 4外接电源',
  ...
  `platform_certified` smallint(6) NOT NULL DEFAULT 0 COMMENT '通过平台认证 0=未通过 1=通过',
  `alarm_mapping` varchar(256) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '主动安全报警映射',
  `order_id` int(11) NOT NULL DEFAULT 0 COMMENT '排序字段',
  `wired_type` int(11) NULL DEFAULT 0 COMMENT '接线类型 1有线 2无线',
  `fix_zone` varchar(6) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '一些设备不能不支持使用本地时区, 容易引起台账错误, 所以网关按设备类型兼容',
  `device_model_compose` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '组合设备，设备型号数组',
  `created_unix` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间戳',
  `updated_unix` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `uk_organize_id`(`product_id`) USING BTREE,
  UNIQUE INDEX `uk_product_name`(`product_name`) USING BTREE,
  UNIQUE INDEX `uk_device_model`(`device_model`) USING BTREE
...
CREATE TABLE `jtt808_alarm`  (
  ...
  `organize_id` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '企业ID',
  `fleet_id` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '线路id',
  `fleet_name` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '线路名称',
  `vehicle_id` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '车辆ID',
  `vehicle_name` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '车辆名称',
  `lpn` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '车牌',
  `imei` varchar(16) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '终端唯一码',
  `event_time` datetime NOT NULL COMMENT '事件时间',
  `platform_alarm_id` int(11) NULL DEFAULT 0 COMMENT '平台统一报警id',
  `alarm_class` varchar(16) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT 'alarm_normal' COMMENT '报警类别 - 实时报警|主动安全',
  `device_type` varchar(16) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '外设类型',
  `additional` varchar(2048) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '附加数据',
  `lng` decimal(11, 6) NOT NULL COMMENT '经度',
  `lat` decimal(11, 6) NOT NULL COMMENT '纬度',
  `duration` int(11) NOT NULL DEFAULT 0 COMMENT '报警持续时长, 用于结束统计',
  ...
  `handle_flag` int(11) NOT NULL DEFAULT 0 COMMENT '处理方式',
  `handle_result` varchar(128) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '附加数据',
  `handle_time` datetime NULL DEFAULT NULL,
  `handler_id` varchar(128) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '附加数据',
  `created_unix` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间戳',
  `updated_unix` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
  PRIMARY KEY (`id`, `event_time`) USING BTREE,
  INDEX `idx_time`(`organize_id`, `event_time`) USING BTREE,
  INDEX `idx_car_time`(`organize_id`, `vehicle_id`, `event_time`) USING BTREE,
  INDEX `idx_date`(`organize_id`, `work_date`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 643399660 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '设备报警记录' ROW_FORMAT = Dynamic;
...
CREATE TABLE `jtt808_alarm_count`  (
  ...
  `vehicle_id` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '车辆ID',
  `work_date` char(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '归属日期',
  `platform_alarm_id` int(11) NOT NULL DEFAULT 0 COMMENT '平台统一报警id',
  ...
  `updated_unix` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_alarm_count`(`organize_id`, `vehicle_id`, `work_date`) USING BTREE,
  INDEX `idx_date`(`organize_id`, `work_date`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 607654 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '报警日小计' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `jtt808_alarm_file`  (
  ...
  `alarm_key` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '平台给报警分配的唯一编号',
  `file_name` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '文件名称',
  ...
  `updated_unix` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `uk_file_name`(`organize_id`, `imei`, `file_name`) USING BTREE,
  INDEX `idx_alarm_key`(`organize_id`, `alarm_key`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1347639 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '设备报警的文件上传记录' ROW_FORMAT = Dynamic;
...
CREATE TABLE `jtt808_alarm_safety`  (
  `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主动安全报警',
  `organize_id` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '企业ID',
  `fleet_id` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '车队id',
  `fleet_name` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '车队名称',
  `vehicle_id` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '车辆ID',
  `vehicle_name` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '车辆名称',
  `lpn` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '车牌',
  `imei` varchar(16) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '终端唯一码',
  `serial_id` int(11) NOT NULL DEFAULT 0 COMMENT '报警自增ID',
  ...
  `updater_id` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '更新操作用户ID',
  `updater_name` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '更新操作账号',
  ...
  `period_time` varchar(13) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '落在的分时段区间 例如：08:00 ~ 08:30',
  `reduce_score` decimal(11, 1) NULL DEFAULT 0.0 COMMENT '一次违规扣分多少',
  `alarm_ignore` smallint(6) NOT NULL DEFAULT 0 COMMENT '报警忽略',
  `card_info` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '驾驶员+刷卡等信息',
  `created_unix` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间戳',
  `updated_unix` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `uk_key`(`organize_id`, `alarm_key`) USING BTREE,
  INDEX `idx_org_workdate_vehicle`(`organize_id`, `work_date`, `vehicle_id`) USING BTREE,
  INDEX `idx_event_time`(`organize_id`, `event_time`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = 'ADAS+DSM报警记录' ROW_FORMAT = Dynamic;
...
CREATE TABLE `jtt808_card`  (
  ...
  `attendance_type` int(11) NOT NULL DEFAULT 0 COMMENT '0刷卡 1上班 2下班 3签到 4签退 5例检',
  `attendance_origin` int(11) NOT NULL DEFAULT 0 COMMENT '考勤方式 0=简易GPS 1员工卡考勤 2输工号考勤 自定义200=GPS附加, 210透传',
  `attendance_check_In` int(11) NULL DEFAULT NULL COMMENT '泰国磁条卡 0签退 1签到',
  `attendance_valid` int(11) NULL DEFAULT NULL COMMENT ' 泰国磁条卡 0非法 1合法',
...
CREATE TABLE `jtt808_cmd`  (
  ...
  `updated_unix` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_batch`(`organize_id`, `batch_id`) USING BTREE,
  INDEX `idx_message_id`(`message_id`) USING BTREE,
  INDEX `idx_time`(`organize_id`, `request_time`) USING BTREE
...
CREATE TABLE `jtt808_cmd_face`  (
  ...
  `face_img_source` int(11) NOT NULL DEFAULT 0 COMMENT '照片来源',
  ...
  `updated_unix` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_face`(`organize_id`, `face_id`) USING BTREE
...
CREATE TABLE `jtt808_connect`  (
  `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '终端连接',
  `organize_id` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '企业ID',
  `fleet_id` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '车队id',
  `fleet_name` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '车队名称',
  `vehicle_id` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '车辆ID',
  ...
  `lpn` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '车牌',
  `imei` varchar(16) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '终端唯一码',
  `address` varchar(128) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '请求地址',
  `ip_region` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '链接地址',
  `token` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '鉴权码',
  `connect_flag` int(11) NOT NULL DEFAULT 0 COMMENT '1建立连接 2断开连接 ',
  ...
  `disconnect_reason` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '鉴权原因',
  `created_unix` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间戳',
  `updated_unix` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_time`(`organize_id`, `connect_time`) USING BTREE,
  INDEX `idx_imei_time`(`organize_id`, `imei`, `connect_time`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 22827259 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '设备连接记录' ROW_FORMAT = Dynamic;
...
CREATE TABLE `jtt808_face`  (
  ...
  `lat` decimal(11, 6) NOT NULL COMMENT '纬度',
  `event_time` datetime NOT NULL COMMENT '事件时间',
  `comparison_result` smallint(6) NULL DEFAULT NULL COMMENT '对比结果，0-匹配成功；1-匹配失败；2-超时；3-没有启用该功能；4-连接异常；5-无指定人脸图片 6-无人脸库',
  `comparison_type` smallint(6) NULL DEFAULT NULL COMMENT '对比类型，0-插卡比对；1-巡检比对；2-点火比对；3-离开返回比对',
...
CREATE TABLE `jtt808_fence`  (
  ...
  `time_zone` char(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '开始时间对应的时区',
  `fence_id` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '围栏ID',
  `fence_name` varchar(128) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '围栏名称',
  `fence_type` int(11) NOT NULL DEFAULT 0 COMMENT '0POI 1圆 2矩形 3多边形 4路径点',
  `fence_category` smallint(6) NOT NULL DEFAULT 0 COMMENT '0常规 10行政区域 ',
  `use_type` smallint(6) NOT NULL DEFAULT 0 COMMENT '区域用途，0默认1停车场2加油充电站3维修点',
  `fence_direction` smallint(6) NOT NULL COMMENT '进出围栏方向，0进围栏 1出围栏',
  `event_time` datetime NOT NULL COMMENT '事件时间',
  ...
  `rule_type` smallint(6) NULL DEFAULT NULL COMMENT '规则类型，0禁入 1禁出',
  `additional_fence` varchar(1024) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '附加数据',
  `created_unix` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间戳',
  `updated_unix` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_event_time`(`organize_id`, `vehicle_id`, `event_time`) USING BTREE,
  INDEX `idx_date`(`organize_id`, `work_date`, `vehicle_id`) USING BTREE,
  INDEX `idx_previous_time`(`organize_id`, `previous_time`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 455670 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '车辆进出区域记录' ROW_FORMAT = Dynamic;
...
CREATE TABLE `jtt808_file_upload`  (
  ...
  `vehicle_name` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '车辆名称',
  `lpn` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '车牌',
  `message_id` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '消息唯一ID.替换UUID',
  `imei` varchar(16) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '终端唯一码',
  `chn` int(11) NOT NULL COMMENT '通道',
  `start_time` datetime NOT NULL COMMENT '文件开始时间',
  `end_time` datetime NOT NULL COMMENT '文件结束时间',
  `warning` bigint(20) NULL DEFAULT NULL COMMENT '报警状态',
  ...
  `task_condition` int(6) NULL DEFAULT 0 COMMENT '下载条件',
  `file_size` int(11) NULL DEFAULT 0 COMMENT '文件大小',
  `upload_state` smallint(6) NOT NULL DEFAULT 0 COMMENT '0等待执行 10下载中 11暂停 12继续 13取消 20完成 30失败',
  ...
  `upload_size` int(11) NULL DEFAULT 0 COMMENT '文件大小(已经上传的大小)',
  `finish_time` datetime NULL DEFAULT NULL COMMENT '完成时间',
  `remark` varchar(128) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '备注信息',
  `serial` int(11) NULL DEFAULT NULL COMMENT '应答流水号',
  `file_expiration_time` datetime NULL DEFAULT NULL COMMENT '文件保存有效期',
  `creator_id` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '请求用户',
  `created_unix` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间戳',
  `updated_unix` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_file_upload`(`organize_id`, `start_time`) USING BTREE,
  INDEX `idx_message_id`(`message_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 229 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '终端文件上传记录' ROW_FORMAT = Dynamic;
...
CREATE TABLE `jtt808_health`  (
  ...
  `has_abnormal` smallint(6) NULL DEFAULT NULL COMMENT '是有有异常, 来源dataItem的abnormalIndicator',
  `data_item` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL COMMENT '体检数据',
  `created_unix` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间戳',
  `updated_unix` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_time`(`organize_id`) USING BTREE,
  INDEX `idx_car_time`(`organize_id`) USING BTREE
...
CREATE TABLE `jtt808_io`  (
  ...
  `event_time` datetime NOT NULL COMMENT '事件时间',
  `previous_second` int(11) NULL DEFAULT NULL COMMENT '同IO上一个时长',
  `next_time` datetime NULL DEFAULT NULL COMMENT '同IO下一个时间',
  `next_second` int(11) NULL DEFAULT NULL COMMENT '同IO下一个时长',
  `io_index` smallint(6) NOT NULL DEFAULT 0 COMMENT 'IO索引 0开始',
  `action_type` varchar(8) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT 'ON | OFF',
  `fence_id` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '围栏ID',
  `fence_name` varchar(128) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '围栏名称',
  `fence_type` int(11) NULL DEFAULT NULL COMMENT '0POI 1圆 2矩形 3多边形 4路径点',
  `fence_category` smallint(6) NULL DEFAULT NULL COMMENT '0常规 10行政区域 ',
  `use_type` smallint(6) NULL DEFAULT NULL COMMENT '区域用途，0默认1停车场2加油充电站3维修点',
  `use_description` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '自定义区域用途描述',
  `additional_io` varchar(1024) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT 'IO开始附加',
  `created_unix` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间戳',
  `updated_unix` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_previous_time`(`organize_id`, `previous_time`, `vehicle_id`) USING BTREE,
  INDEX `idx_event_time`(`organize_id`, `vehicle_id`, `event_time`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1689538 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = 'IO变化' ROW_FORMAT = Dynamic;
...
CREATE TABLE `jtt808_media_file`  (
  ...
  `lpn` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '车牌',
  `imei` varchar(16) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '终端唯一码',
  `chn` smallint(5) UNSIGNED NOT NULL DEFAULT 0 COMMENT '通道号',
  `media_id` bigint(11) UNSIGNED NOT NULL DEFAULT 0 COMMENT '多媒体ID',
  `media_file_type` int(11) UNSIGNED NOT NULL DEFAULT 0 COMMENT '多媒体类型 0图像 1音频 2视频',
  `media_file_format` int(11) UNSIGNED NOT NULL DEFAULT 0 COMMENT '文件格式 BYTE 0：JPEG；1：TIF；2：MP3；3：WAV；4：WMV',
  `media_event` int(11) UNSIGNED NOT NULL DEFAULT 0 COMMENT '时间项编码  0：平台下发指令；1：定时动作；2：抢劫报警触发；3：碰撞侧翻报警触发 等',
  `coordinate_info` varchar(1024) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '位置信息',
  `relative_path` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '存储路径',
  ...
  `message_id` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '触发抓拍事件的消息唯一ID.替换UUID',
  `event_type` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '事件的类型, 比如进出围栏等',
  `event_id` bigint(20) NULL DEFAULT NULL COMMENT '触发事件的表ID',
  `file_expiration_time` datetime NULL DEFAULT NULL COMMENT '文件保存有效期',
  `created_unix` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间戳',
  `updated_unix` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_time`(`organize_id`, `created_unix`) USING BTREE,
  INDEX `idx_media_id`(`imei`, `chn`, `media_id`) USING BTREE,
  INDEX `idx_event`(`organize_id`, `event_type`, `event_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 7381 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '多媒体文件上传记录' ROW_FORMAT = Dynamic;
...
CREATE TABLE `jtt808_media_photograph`  (
  ...
  `chn` smallint(5) UNSIGNED NOT NULL DEFAULT 0 COMMENT '通道号',
  `message_id` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '消息唯一ID.替换UUID',
  `rsp_result` int(11) NOT NULL DEFAULT -1 COMMENT '0：成功；1：失败；2：通道不支持。 以下字段在结果=0 时才有效',
  `media_ids` varchar(1024) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '抓拍多媒体数组',
  ...
  `updated_unix` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `uk_message_id`(`organize_id`, `message_id`) USING BTREE,
  INDEX `idx_time`(`organize_id`, `vehicle_id`, `created_unix`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 7 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '多媒体抓拍数据上传记录' ROW_FORMAT = Dynamic;
...
CREATE TABLE `jtt808_obd`  (
  ...
  `imei` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '设备唯一码',
  `event_time` datetime NOT NULL COMMENT '事件时间',
  `obd_base` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT 'OBD基础数据',
  `obd_car` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT 'OBD轿车数据',
  `obd_truck` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT 'OBD货车数据',
...
CREATE TABLE `jtt808_passenger`  (
  ...
  `lpn` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '车牌',
  `imei` varchar(16) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '终端唯一码',
  `route_id` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '线路',
  ...
  `route_code` int(11) NULL DEFAULT NULL COMMENT '运行线路编号',
  ...
  `stop_id` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '站台ID',
  ...
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_time`(`organize_id`, `upload_time`) USING BTREE,
  INDEX `idx_work_date`(`organize_id`, `work_date`, `vehicle_id`) USING BTREE
...
CREATE TABLE `jtt808_position`  (
  ...
  `lpn` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '车牌',
  `imei` varchar(16) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '终端唯一码',
  `state` bigint(11) NULL DEFAULT NULL COMMENT '车辆状态',
  `warning` bigint(11) NULL DEFAULT NULL COMMENT '报警状态',
  `lng` decimal(11, 6) NOT NULL COMMENT '经度',
  `lat` decimal(11, 6) NOT NULL COMMENT '纬度',
  ...
  `additional` varchar(1024) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '附加数据',
  `properties` varchar(512) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '附加数据',
  `created_unix` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间戳',
  `updated_unix` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
  PRIMARY KEY (`id`, `event_time`) USING BTREE,
  INDEX `idx_time`(`organize_id`, `event_time`) USING BTREE,
  INDEX `idx_car_time`(`organize_id`, `vehicle_id`, `event_time`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1124544139 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '终端设备的GPS数据' ROW_FORMAT = Dynamic;
...
CREATE TABLE `jtt808_position_last`  (
  `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '自增长ID',
  `organize_id` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '组织ID',
  `organize_name` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '组织全名',
  `vehicle_id` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '车辆编号',
  `lpn` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '车牌号码 License Plate Number',
  `imei` varchar(16) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `lng` decimal(11, 6) NOT NULL COMMENT '经度',
  `lat` decimal(11, 6) NOT NULL COMMENT '纬度',
  `height` smallint(6) NULL DEFAULT NULL COMMENT '高度',
  `speed` smallint(6) NULL DEFAULT NULL COMMENT '速度',
  ...
  `updated_unix` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
  PRIMARY KEY (`id`, `event_time`) USING BTREE,
  INDEX `idx_vehicle`(`organize_id`, `vehicle_id`) USING BTREE,
  INDEX `idx_lpn`(`organize_id`, `lpn`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '车辆最后位置' ROW_FORMAT = Dynamic;
...
CREATE TABLE `jtt808_register`  (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '车辆上安装的设备列表',
  `organize_id` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '企业ID',
  `fleet_id` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '线路id',
  `fleet_name` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '线路名称',
  `vehicle_id` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '车辆ID',
  ...
  `ip_region` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '链接地址',
  `header_properties` int(11) NOT NULL DEFAULT 0 COMMENT '头属性',
  `header_version` int(11) NOT NULL DEFAULT 0 COMMENT '头属性-版本',
  `province` int(11) NOT NULL DEFAULT 0 COMMENT '省域ID',
  `city` int(11) NOT NULL DEFAULT 0 COMMENT '市县域ID',
  ...
  `terminal_lpc` int(11) NOT NULL DEFAULT 0 COMMENT '车牌颜色',
  `terminal_lpn` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '车牌',
  `event_time` datetime NOT NULL COMMENT '事件时间',
  `registration_rsp` int(11) NOT NULL DEFAULT 0 COMMENT '注册应答',
  `created_unix` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间戳',
  `updated_unix` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
  PRIMARY KEY (`id`, `event_time`) USING BTREE,
  UNIQUE INDEX `uk_imei_model`(`imei`, `terminal_model`) USING BTREE,
  INDEX `idx_organize`(`organize_id`) USING BTREE
...
CREATE TABLE `jtt808_tpms`  (
  ...
  `lpn` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '车牌',
  `imei` varchar(16) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '终端唯一码',
  `sensor_id` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '传感器ID',
  `tire_index` int(11) NOT NULL DEFAULT 0 COMMENT '轮胎索引',
  `tire_position` int(11) NOT NULL DEFAULT 0 COMMENT '轮胎位置',
  `sensor_battery_voltage` int(11) NOT NULL DEFAULT 0 COMMENT '电池电量',
  `tire_pressure` decimal(11, 1) NOT NULL DEFAULT 0.0 COMMENT '胎压',
  `tire_temperature` int(11) NOT NULL DEFAULT 0 COMMENT '轮胎温度',
  `tire_state` int(11) NOT NULL DEFAULT 0 COMMENT '轮胎状态',
  `event_time` datetime NOT NULL COMMENT '事件时间',
  `created_unix` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间戳',
  `updated_unix` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `jtt808_tpms_vehicle_id_IDX`(`vehicle_id`, `event_time`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 75820 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '设备胎压记录' ROW_FORMAT = Dynamic;
...
CREATE TABLE `jtt808_video_storage`  (
  ...
  `fleet_name` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '线路名称',
  `vehicle_id` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '车辆编号',
  `vehicle_name` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '组织全名',
  `lpn` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '车牌号码 License Plate Number',
  `imei` varchar(16) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `chn` int(11) NOT NULL DEFAULT 0 COMMENT '通道',
  `domain` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT 'nginx映射的域名',
  `path` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT 'minio中的相对路径',
  `duration` int(11) NOT NULL DEFAULT 0 COMMENT '文件时长 毫秒',
  ...
  `updated_unix` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_vehicle`(`organize_id`, `vehicle_id`, `start_time`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 681903 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '车辆最后位置' ROW_FORMAT = Dynamic;
...
CREATE TABLE `ledger_daily_mileage`  (
  ...
  `is_abnormal` smallint(6) NOT NULL DEFAULT 0 COMMENT '是否异常',
  `is_reissue` smallint(6) NOT NULL DEFAULT 0 COMMENT '补传标识 0自动台账 1自动补录 2手工台账',
  ...
  `total_position` int(11) NOT NULL DEFAULT 0 COMMENT '当天GPS总数量',
  `not_located` int(11) NOT NULL DEFAULT 0 COMMENT '没有定位的坐标数量',
  `wrong_position` int(11) NOT NULL DEFAULT 0 COMMENT '经度范围, 速度, 海拔, 方位角不合法的数据',
  `reissue_count` int(11) NULL DEFAULT 0 COMMENT '补传包数量',
  `discontinuous_count` int(11) NOT NULL DEFAULT 0 COMMENT '轨迹不连续',
  `drift_count` int(11) NOT NULL DEFAULT 0 COMMENT '漂移数量',
  `online_second` int(11) NOT NULL DEFAULT 0 COMMENT '当天在线时长, 来源GPS轨迹分析',
  `creator_id` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '创建用户',
  `created_unix` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间戳',
  `updated_unix` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `ix_date_car`(`organize_id`, `work_date`, `vehicle_id`, `imei`) USING BTREE
...
CREATE TABLE `ledger_parking`  (
  ...
  `duration_second` int(11) NOT NULL DEFAULT 0 COMMENT '行程内停车的时长',
  ...
  `parking_flag` smallint(6) NOT NULL DEFAULT 0 COMMENT '标识 0=停车 1=行程(ACC开时的空转) 2=离线',
  ...
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_date`(`organize_id`, `work_date`, `vehicle_id`) USING BTREE,
  INDEX `idx_time`(`organize_id`, `start_time`) USING BTREE,
  INDEX `idx_vehicle_time`(`organize_id`, `vehicle_id`, `start_time`) USING BTREE
...
CREATE TABLE `ledger_timeline`  (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '标识 1上线',
  `organize_id` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '企业ID',
  `fleet_id` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '线路id',
  `fleet_name` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '线路名称',
  `vehicle_id` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '车辆ID',
  ...
  `flag` smallint(6) NOT NULL DEFAULT 0 COMMENT '标识 1上线 2下线 10=补传11=轨迹不连续 12=漂移',
  `duration_second` int(11) NOT NULL DEFAULT 0 COMMENT '时长',
  `num` int(11) NULL DEFAULT 0 COMMENT '定位包数量',
  `additional` varchar(1024) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '附加数据',
  `creator_id` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '创建用户',
  `created_unix` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间戳',
  `updated_unix` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_time`(`organize_id`, `vehicle_id`, `start_time`) USING BTREE,
  INDEX `idx_date`(`organize_id`, `work_date`, `vehicle_id`) USING BTREE
...
CREATE TABLE `ledger_trip_index`  (
  ...
  `first_acc_on_id` bigint(20) NOT NULL DEFAULT 0 COMMENT '行程开始坐标ID, 0行驶中',
  `last_acc_on_id` bigint(20) NOT NULL DEFAULT 0 COMMENT '行程之后一个acc on的ID',
  ...
  `last_position_id` bigint(20) NOT NULL DEFAULT 0 COMMENT '最后一个坐标包的ID',
  `last_trip_end_id` bigint(11) NOT NULL DEFAULT 0 COMMENT '最后行程的结束点, 也就是停车的开始点',
...
CREATE TABLE `ledger_trip_vehicle`  (
  ...
  `end_time` datetime NOT NULL COMMENT '行程结束时间',
  `end_mileage` decimal(11, 3) NOT NULL COMMENT '行车结束里程',
  `trip_duration_second` int(11) NOT NULL DEFAULT 0 COMMENT '行程持续多少秒',
  `idle_duration_second` int(11) NOT NULL DEFAULT 0 COMMENT '行程内停车的时长',
  `trip_mileage` decimal(11, 3) NOT NULL DEFAULT 0.000 COMMENT '行程里程Km',
  `max_speed` int(11) NOT NULL DEFAULT 0 COMMENT '行程最高速度',
  `avg_speed` int(11) NOT NULL DEFAULT 0 COMMENT '行程平均车速',
  `fuel_consumed` decimal(11, 1) NULL DEFAULT NULL COMMENT '燃油油耗',
...
CREATE TABLE `log_geocoder`  (
  ...
  `is_organize_key` smallint(6) NOT NULL DEFAULT 0 COMMENT '是否来源组织 0否 1是',
  `is_cache` smallint(6) NOT NULL DEFAULT 0 COMMENT '是否来源缓存 0否 1是',
  `is_success` smallint(6) NOT NULL DEFAULT 0 COMMENT '地址解析成功 0否 1是',
  ...
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_time`(`organize_id`, `created_unix`) USING BTREE,
  INDEX `idx_month`(`organize_id`, `work_date`) USING BTREE
...
CREATE TABLE `log_login`  (
  ...
  `login_type` smallint(6) NULL DEFAULT 0 COMMENT '登录方式',
  `logout_unix` timestamp NULL DEFAULT NULL COMMENT '退出时间',
  `logout_type` smallint(6) NULL DEFAULT 0 COMMENT '过期退出标识, 1过期退出',
  `third_party_type` int(11) NOT NULL DEFAULT 0 COMMENT '第三方登录类型 0账号密码 10手机短信 20邮箱 30微信 40line',
  `ip` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT 'IP地址',
  `ip_region` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '链接地址',
  ...
  `updated_unix` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_user`(`user_id`, `login_unix`) USING BTREE,
  INDEX `idx_login`(`login_unix`) USING BTREE,
  INDEX `idx_session`(`session_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 12144 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '登录日志' ROW_FORMAT = Dynamic;
...
CREATE TABLE `log_mail`  (
  ...
  `has_exception` smallint(6) NOT NULL DEFAULT 0 COMMENT '发送异常',
  `created_unix` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间戳',
  `updated_unix` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_time`(`organize_id`, `created_unix`) USING BTREE
...
CREATE TABLE `log_message`  (
  `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '用户关注的组织或者个人工程师，自增长ID',
  ...
  `error_count` int(11) NOT NULL DEFAULT 0 COMMENT '错误数量',
  `created_unix` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间戳',
  `updated_unix` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_phone`(`phone_number`) USING BTREE,
  INDEX `idx_time`(`created_unix`) USING BTREE
...
CREATE TABLE `log_system`  (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '操作日志id',
  `user_id` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '操作人',
  `organize_id` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '组织ID',
  `api_url` varchar(128) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '请求路径',
  `methods` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '执行方法',
  `api_param` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '请求参数',
  `api_response` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT 'api返回code',
  `api_version` varchar(16) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT 'API版本号',
  ...
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_time`(`created_unix`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1379550 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '系统日志' ROW_FORMAT = Dynamic;
...
CREATE TABLE `log_text`  (
  ...
  `vehicle_name` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '车辆名称',
  `imei` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '设备唯一码',
  `character_set` varchar(16) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '字符集',
  `msg` varchar(1024) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '消息',
  `flag` int(11) NOT NULL DEFAULT 0,
  `message_id` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '消息唯一ID.替换UUID',
  `batch_id` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '批量下发标识',
  `send_state` smallint(6) NOT NULL DEFAULT 0 COMMENT '应答结果 0默认 1发送中 2发送成功 3发送失败',
  ...
  INDEX `idx_batch`(`organize_id`, `batch_id`) USING BTREE,
  INDEX `idx_message_id`(`message_id`) USING BTREE,
  INDEX `idx_time`(`organize_id`, `send_time`) USING BTREE
...
CREATE TABLE `order_contact_address`  (
  ...
  INDEX `idx_form_organize_id`(`form_organize_id`) USING BTREE,
  INDEX `idx_to_organize_id`(`to_organize_id`) USING BTREE
...
CREATE TABLE `order_daily_duration`  (
  `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '工单归档。计算当天归档工单的耗时分析',
  ...
  `order_type` int(11) NOT NULL DEFAULT 0 COMMENT '1安装单 2维修单',
  `num_order` int(11) UNSIGNED NOT NULL DEFAULT 0 COMMENT '当天审核完成单',
  `duration_order` int(11) NOT NULL DEFAULT 0 COMMENT '工单持续时长',
  `duration_assign` int(11) NOT NULL DEFAULT 0 COMMENT '配单耗时, 分钟',
  `duration_accept` int(11) NOT NULL DEFAULT 0 COMMENT '接单耗时, 分钟',
  `duration_done` int(11) NOT NULL DEFAULT 0 COMMENT '服务耗时, 分钟',
  `duration_confirm` int(11) NOT NULL DEFAULT 0 COMMENT '签单耗时, 分钟',
  `is_deleted` int(11) NOT NULL DEFAULT 0 COMMENT '删除位',
  `created_unix` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间戳',
  `updated_unix` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_date`(`work_date`) USING BTREE,
  INDEX `idx_month`(`work_month`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 45609 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '每日交单工单耗时分析' ROW_FORMAT = Dynamic;
...
CREATE TABLE `order_daily_engineer`  (
  `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '工单归档。工程师日交付单明细',
  ...
  `duration_done` int(11) NOT NULL DEFAULT 0 COMMENT '服务耗时, 分钟',
  `duration_confirm` int(11) NOT NULL DEFAULT 0 COMMENT '签单耗时, 分钟',
  `service_score` int(11) NOT NULL DEFAULT 0 COMMENT '评分',
  `created_unix` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间戳',
  `updated_unix` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_month`(`work_month`) USING BTREE,
  INDEX `idx_date`(`work_date`, `user_id`) USING BTREE
...
CREATE TABLE `order_daily_organize`  (
  ...
  `organize_type` smallint(6) NOT NULL COMMENT '组织类型 1发单 2接单',
  `work_month` varchar(7) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '月份yyyy-mm',
  `work_date` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '日期yyyy-mm-dd',
  `order_no` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '订单编号 唯一值，供客户查询',
  `order_type` int(11) NOT NULL DEFAULT 0 COMMENT '1安装单 2维修单',
...
CREATE TABLE `order_master`  (
  ...
  `order_type` smallint(1) NOT NULL DEFAULT 0 COMMENT '1 安装订单 2 维修订单',
  `order_subtype` smallint(1) NOT NULL DEFAULT 0 COMMENT '0 默认 11 新装 12加装 21维修 22检修 23拆机 24换机 25移机',
  `order_category` smallint(5) UNSIGNED NOT NULL DEFAULT 0 COMMENT '0默认 10内部单 20外部指定服务商 30外部议价单',
  ...
  `warning_state` smallint(6) NOT NULL DEFAULT 0 COMMENT '工单预警状态 0正常 1派单超时 2接单超时 3交单超时 4签单超时',
  `service_score` smallint(6) NULL DEFAULT 0 COMMENT '评价得分',
  `remark` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '备注信息',
  `is_archive` smallint(6) NOT NULL DEFAULT 0 COMMENT '归档',
  ...
  INDEX `idx_organize_id`(`organize_id`) USING BTREE,
  INDEX `idx_organize_id2`(`distribute_organize_id`) USING BTREE,
  INDEX `idx_finish_date`(`finish_date`) USING BTREE
...
CREATE TABLE `order_monthly_engineer`  (
  ...
  `work_month` varchar(7) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '月份 yyyy-mm',
  `order_type` int(11) NOT NULL DEFAULT 0 COMMENT '1安装单 2维修单',
  `num_order` int(11) NOT NULL DEFAULT 0 COMMENT '交付的工单',
  `sum_service_score` int(11) NOT NULL DEFAULT 0 COMMENT '评分',
  `is_deleted` int(11) NOT NULL DEFAULT 0 COMMENT '删除位',
  `created_unix` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间戳',
  `updated_unix` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_month`(`organize_id`, `user_id`, `work_month`) USING BTREE
...
CREATE TABLE `order_monthly_organize`  (
  ...
  `work_month` varchar(7) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '月份 yyyy-mm',
  `order_type` int(11) NOT NULL DEFAULT 0 COMMENT '1安装单 2维修单',
  `num_published` int(11) NOT NULL DEFAULT 0 COMMENT '发布的工单',
  `num_received` int(11) NOT NULL DEFAULT 0 COMMENT '接到的工单',
  `is_deleted` int(11) NOT NULL DEFAULT 0 COMMENT '删除位',
  `created_unix` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间戳',
  `updated_unix` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_month`(`organize_id`, `work_month`) USING BTREE
...
CREATE TABLE `order_quoted_price`  (
  ...
  `order_no` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '订单编号 唯一值，供客户查询',
  `quoted_price` int(11) NOT NULL COMMENT '报价，单位分',
  ...
  `num_times` smallint(5) UNSIGNED NOT NULL DEFAULT 0 COMMENT '次数，控制一个工单只能报价三次',
  `price_status` smallint(6) NOT NULL DEFAULT 0 COMMENT '1同意 2拒绝 3失效',
...
CREATE TABLE `order_record_install_item`  (
  ...
  `wired_type` int(11) NOT NULL DEFAULT 1 COMMENT '接线类型 1有线 2无线',
  ...
  `manufacturer_id` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT '' COMMENT '生产厂家',
  `manufacturer_name` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '生产厂家',
  `test_location` int(11) NULL DEFAULT 0 COMMENT '0 未测试 1 测试通过 2 未通过',
  `created_unix` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间戳',
  `updated_unix` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_order_no`(`order_no`) USING BTREE
...
CREATE TABLE `order_record_maintenance`  (
  ...
  `repair_scheme` int(11) NOT NULL DEFAULT 1 COMMENT '维修方案	1仅维修 2-设备更换 3-重新安装',
...
CREATE TABLE `order_third_main`  (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '第三方工单',
  `organize_id` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '企业ID',
  `organize_name` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '组织全名',
  ...
  `order_type` int(11) NOT NULL DEFAULT 0 COMMENT '1 安装订单 2 维修订单',
  `order_subtype` int(1) NOT NULL DEFAULT 0 COMMENT '0 默认 11 新装 12加装 21维修 22检修 23拆机 24换机 25移机',
  `order_status` int(11) NOT NULL DEFAULT 0 COMMENT '工单状态',
  `order_status_external` int(11) NOT NULL DEFAULT 0 COMMENT '工单状态-外部的API',
  `order_status_internal` int(11) NOT NULL DEFAULT 0 COMMENT '工单状态-内部的API',
  ...
  `creator_id` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '创建者(发单者)',
  `creator_name` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '创建者(发单者)',
  `remark_sync` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL COMMENT '同步语句的最后结果',
  `is_archived` int(11) NOT NULL DEFAULT 0 COMMENT '0未归档 1已归档',
  `created_unix` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间戳',
  `updated_unix` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `order_third_main_un`(`organize_id`, `order_no_external`, `is_archived`) USING BTREE,
  INDEX `order_no_external`(`order_no_external`) USING BTREE,
  INDEX `order_no_internal`(`order_no_internal`) USING BTREE,
  INDEX `idx_time`(`appointment_time`) USING BTREE
...
CREATE TABLE `order_third_party`  (
  ...
  `wiredless_total` int(11) NOT NULL COMMENT '无线设备总数',
  `wired_total` int(11) NOT NULL DEFAULT 0 COMMENT '有线 GPS 总数',
  `gps_total` int(11) NULL DEFAULT NULL COMMENT 'gps 总数',
  `status` int(11) NOT NULL DEFAULT 0 COMMENT '工单状态 10=待派单 20=安装中 30=已',
  `created_unix` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间戳',
  `updated_unix` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `order_timeline`  (
  ...
  `order_status_before` smallint(1) NOT NULL DEFAULT 0 COMMENT '之前订单状态',
  `order_status_after` smallint(1) NOT NULL DEFAULT 0 COMMENT '之后订单状态',
...
CREATE TABLE `organize_accessories_device`  (
  ...
  `updated_unix` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `organize_accessories_number`(`organize_id`, `accessories_number`) USING BTREE,
  UNIQUE INDEX `organize_accessories_name`(`organize_id`, `accessories_name`) USING BTREE
...
CREATE TABLE `organize_accessories_vehicle`  (
  ...
  `updated_unix` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_vehicle`(`organize_id`) USING BTREE
...
CREATE TABLE `organize_audio`  (
  ...
  `creator_id` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '创建用户',
  `created_unix` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间戳',
  `updated_unix` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `organize_bus_stop`  (
  ...
  `path_line` int(11) NULL DEFAULT 0 COMMENT '途径线路',
...
CREATE TABLE `organize_config_video`  (
  ...
  `organize_id` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `vehicle_id` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '车辆ID',
  `vehicle_name` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '车辆名称',
  `lpn` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '车牌号',
  `imei` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '设备号',
  `config` varchar(2048) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '配置信息json',
  `creator_id` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '创建用户',
  ...
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `uk_imei`(`organize_id`, `imei`) USING BTREE,
  UNIQUE INDEX `uk_vehicle`(`organize_id`, `vehicle_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 145 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '视频配置管理' ROW_FORMAT = Dynamic;
...
CREATE TABLE `organize_device`  (
  ...
  `time_zone` varchar(6) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '+08:00' COMMENT '设备台账时区',
  `character_set` varchar(16) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT 'GBK' COMMENT '字符集GBK或UTF-8',
  ...
  `is_slave` tinyint(4) NOT NULL DEFAULT 0 COMMENT '是否备机',
  ...
  `updated_unix` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `uk_imei`(`device_imei`) USING BTREE,
  INDEX `idx_vehicle`(`organize_id`, `vehicle_id`) USING BTREE
...
CREATE TABLE `organize_device_compose`  (
  ...
  `updated_unix` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `uk_device_key`(`imei`, `device_key`) USING BTREE,
  INDEX `idx_vehicle`(`organize_id`, `vehicle_id`) USING BTREE
...
CREATE TABLE `organize_device_product`  (
  ...
  `creator_id` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '创建用户',
  `created_unix` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间戳',
  `updated_unix` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `idx_organize_product_id`(`organize_id`, `product_id`) USING BTREE
...
CREATE TABLE `organize_employee`  (
  ...
  `updated_unix` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `uk_emp`(`organize_id`, `emp_id`) USING BTREE
...
CREATE TABLE `organize_employee_card`  (
  ...
  `card_label` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '卡标签',
  `emp_id` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '工号',
  `emp_name` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '姓名',
  `emp_type` smallint(6) NOT NULL DEFAULT 1 COMMENT '员工类型 0默认1 驾驶员 2乘务员 3站务',
  `creator_id` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '创建账号id',
  ...
  `updated_unix` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `uk_physical_number`(`organize_id`, `physical_number`) USING BTREE,
  UNIQUE INDEX `uk_card_label`(`organize_id`, `card_label`) USING BTREE
...
CREATE TABLE `organize_fence`  (
  ...
  `organize_id` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '企业id',
  `fence_id` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '自编码',
  `group_id` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '围栏分组id',
  `fence_name` varchar(128) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '站台名称',
  `fence_code` int(11) NULL DEFAULT NULL COMMENT '定点编号',
  `fence_type` int(11) NOT NULL DEFAULT 0 COMMENT '0POI 1圆 2矩形 3多边形 4路径点',
  `fence_category` smallint(6) NOT NULL DEFAULT 0 COMMENT '0常规 10行政区域 ',
  `use_type` smallint(6) NOT NULL DEFAULT 0 COMMENT '区域用途，0默认1停车场2加油充电站3维修点 100自定义',
  `use_description` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '自定义区域用途描述',
  ...
  `fence_points` varchar(4096) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '路径点 [{lat1,lng1,r1},{lat2,lng2, r2}]',
  `fence_option` varchar(2048) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '自定义样式，json字符串',
  `is_share` tinyint(4) NOT NULL DEFAULT 0 COMMENT '企业内共享 0私有 1公用',
  ...
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `uk_fence_id`(`fence_id`) USING BTREE,
  INDEX `ix_fence`(`organize_id`, `fence_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 21550 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '区域管理' ROW_FORMAT = Dynamic;
...
CREATE TABLE `organize_fence_group`  (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '围栏用途分钟',
  `organize_id` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '企业id',
  `group_id` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '0' COMMENT '自定义围栏组Id',
  `group_name` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '自定义围栏组名称',
  `parent_id` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '父节点',
  `creator_id` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '创建用户',
  `created_unix` timestamp NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建日期',
  `updated_unix` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `uk_fence_group`(`organize_id`, `group_name`, `creator_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 5 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '自定义用途分组' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `organize_firmware_ota`  (
  ...
  `message_id` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '消息唯一ID.替换UUID',
  `is_archived` int(11) NOT NULL DEFAULT 0 COMMENT '归档标记 0 默认 1 已归档',
  `creator_id` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '创建用户',
  `created_unix` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间戳',
  `updated_unix` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `organize_firmware_ota_organize_id_IDX`(`organize_id`, `is_archived`, `created_unix`) USING BTREE,
  INDEX `message_id`(`organize_id`, `vehicle_id`, `message_id`) USING BTREE
...
CREATE TABLE `organize_fleet`  (
  ...
  `updated_unix` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_fleet`(`organize_id`, `fleet_id`) USING BTREE
...
CREATE TABLE `organize_info`  (
  ...
  `nation_code` int(11) NULL DEFAULT NULL COMMENT '国家代码',
  ...
  `num_members` int(11) NOT NULL DEFAULT 0 COMMENT '成员数量',
  `num_published` int(11) NOT NULL DEFAULT 0 COMMENT '企业累计发单',
  `num_received` int(11) NOT NULL DEFAULT 0 COMMENT '企业累计接单',
  ...
  `max_followers` smallint(6) UNSIGNED NOT NULL DEFAULT 5 COMMENT '企业最多可创建的下游组织ID',
  `is_partner` smallint(6) NOT NULL DEFAULT 0 COMMENT '城市合伙人，拍档',
  ...
  `updated_unix` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `uk_organize_id`(`organize_id`) USING BTREE,
  UNIQUE INDEX `uk_organize_name`(`organize_name`) USING BTREE,
  INDEX `idx_follow_id`(`follow_organize_id`) USING BTREE
...
CREATE TABLE `organize_info_authentication`  (
  ...
  `check_status` int(11) NOT NULL DEFAULT 0 COMMENT '审核状态  1通过 2拒绝',
  ...
  `is_deleted` bigint(20) NOT NULL DEFAULT 0 COMMENT '删除位',
  `created_unix` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间戳',
  `updated_unix` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `uk_user`(`user_id`, `is_deleted`) USING BTREE,
  UNIQUE INDEX `uk_organization_code`(`organization_code`, `is_deleted`) USING BTREE
...
CREATE TABLE `organize_order_optional`  (
  ...
  `is_template` smallint(6) NOT NULL DEFAULT 0 COMMENT '是否模板,用于自动复制',
  `created_unix` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间戳',
  `updated_unix` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
  ...
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `uk_optional`(`optional_id`) USING BTREE
...
CREATE TABLE `organize_partner_city`  (
  ...
  `updated_unix` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `uk_organize_id`(`organize_id`, `city_code`) USING BTREE
...
CREATE TABLE `organize_permission`  (
  `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '组织职务自定义权限',
  `organize_id` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '组织ID',
...
CREATE TABLE `organize_quota`  (
  ...
  `stock_count` int(11) NOT NULL DEFAULT 100 COMMENT '还可以用多少次',
  `version` int(11) NOT NULL DEFAULT 0 COMMENT '并发版本控制',
  `created_unix` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间戳',
  `updated_unix` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `uk_organize_id`(`organize_id`, `quota_key`, `month`) USING BTREE,
  INDEX `ix_organize_id_quota_key`(`organize_id`, `quota_key`) USING BTREE
...
CREATE TABLE `organize_renewal`  (
  ...
  `renewal_statue` smallint(6) NOT NULL DEFAULT 0 COMMENT '当前状态 0待审核 1审核中 2已审核通过 3审核不通过',
  `duration_value` int(11) NOT NULL DEFAULT 0 COMMENT '续约时长',
  `duration_unit` int(11) NOT NULL DEFAULT 0 COMMENT '续约单位 0天 1月',
  `start_time` datetime NULL DEFAULT NULL COMMENT '开始时间',
  ...
  `updated_unix` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `uk_code`(`organize_id`, `renewal_code`) USING BTREE
...
CREATE TABLE `organize_role`  (
  ...
  `is_share` int(11) NOT NULL DEFAULT 0 COMMENT '0企业自定义 1系统共享',
  ...
  `updated_unix` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `uk_organize_role`(`organize_id`, `role_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 221 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '组织角色管理' ROW_FORMAT = Dynamic;
...
CREATE TABLE `organize_route`  (
  ...
  `route_state` int(11) NOT NULL DEFAULT 0 COMMENT '0暂未开通 10运营 20停运',
  `route_category` smallint(6) NOT NULL DEFAULT 0 COMMENT '线路类别,0双向线路 1单向环线 2双向环线',
  `route_travel` smallint(6) NOT NULL DEFAULT 0 COMMENT '行驶类型 0全部站点 1支线 2区间 3大站',
  `route_ticket` smallint(6) NOT NULL DEFAULT 0 COMMENT '0无人售票 1有人售票',
...
CREATE TABLE `organize_route_direction`  (
  ...
  `route_id` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '线路id',
  `direction` smallint(6) NOT NULL COMMENT '方向 1上行 2下行 3环线',
...
CREATE TABLE `organize_route_station`  (
  ...
  `station_serial` smallint(6) UNSIGNED NOT NULL COMMENT '站序，不能为负数',
...
CREATE TABLE `organize_rule`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `organize_id` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '组织ID',
  `rule_type` smallint(6) NOT NULL COMMENT '规则类型，0禁入 1禁出',
  ...
  `fence_direction` int(11) NOT NULL DEFAULT 0 COMMENT '围栏方向',
  ...
  `fence_type` smallint(6) NOT NULL DEFAULT 0 COMMENT '区域类型 0点，1圆，2矩形，3多边形，4多段线',
  `fence_category` smallint(6) NOT NULL DEFAULT 0 COMMENT '区域分类 0自定义区域，1行政区域',
  `time_range` varchar(17) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '时间范围 00:00:00~00:00:00',
  `is_share` smallint(6) NOT NULL DEFAULT 0 COMMENT '全局共享',
  ...
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `uk_rule`(`rule_id`) USING BTREE,
  INDEX `idx_rule`(`organize_id`, `rule_id`) USING BTREE
...
CREATE TABLE `organize_rule_vehicle`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `uk_vehicle`(`organize_id`, `rule_id`, `vehicle_id`) USING BTREE,
  INDEX `idx_vehicle`(`organize_id`, `vehicle_id`) USING BTREE
...
CREATE TABLE `organize_sim`  (
  ...
  `flow_mb` int(11) NULL DEFAULT 0 COMMENT '流量MB',
  ...
  INDEX `idx_sim`(`organize_id`, `iccid`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 20 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = 'SIM卡管理' ROW_FORMAT = Dynamic;
...
CREATE TABLE `organize_star`  (
  ...
  `star_type` int(11) NOT NULL DEFAULT 0 COMMENT '企业关联关系，1=收藏 2合作工单,接单之后标注',
  `created_unix` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间戳',
  `updated_unix` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `organize_vehicle`  (
  ...
  `approved_number` int(11) NULL DEFAULT 0 COMMENT '核载人数',
  `lpn_color` int(11) NOT NULL DEFAULT 9 COMMENT '车牌颜色 1蓝色 2黄色 3黑色 4白色 9其他',
  ...
  `tpms_info` varchar(1024) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT 'tpms轮胎位置图JSON对象',
  ...
  `remark` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '备注信息',
  `dlt` int(11) NOT NULL DEFAULT 0 COMMENT 'DLT，0代表非DLT，1表是DLT',
  `active` int(11) NOT NULL DEFAULT 0 COMMENT '0表活动，1表等待(3 个月)，1表等待(6 个月),  3表过期，4表过期， 5表取消',
  ...
  `updated_unix` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `uk_lpn`(`organize_id`, `lpn`) USING BTREE,
  INDEX `idx_vehicle`(`organize_id`, `vehicle_id`) USING BTREE
...
CREATE TABLE `organize_vehicle_employee`  (
  ...
  `updated_unix` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `organize_vehicle_employee_organize_id_IDX`(`organize_id`, `vehicle_id`, `emp_id`) USING BTREE
...
CREATE TABLE `organize_vehicle_fence`  (
  ...
  `created_unix` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `uk_vehicle_fence`(`organize_id`, `vehicle_id`, `fence_id`) USING BTREE
...
CREATE TABLE `organize_vehicle_maintain`  (
  ...
  `interval_month` smallint(6) NOT NULL DEFAULT 6 COMMENT '保养间隔时间(月)',
  `next_maintain_date` datetime NOT NULL COMMENT '下次保养日期',
  `maintain_mileage` int(11) NOT NULL DEFAULT 0 COMMENT '保养里程(km)',
  `interval_mileage` int(11) NOT NULL DEFAULT 0 COMMENT '保养间隔里程(km)',
  `next_maintain_mileage` int(11) NOT NULL DEFAULT 0 COMMENT '下次保养里程(km)',
  ...
  `is_archive` smallint(6) NOT NULL DEFAULT 0 COMMENT '是否归档，0=未归档，1=已归档',
  `remark` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '备注',
  `creator_id` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '创建者',
  `updated_unix` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  `created_unix` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_vehicle`(`organize_id`, `vehicle_id`) USING BTREE,
  INDEX `idx_vehicle_date`(`organize_id`, `vehicle_id`, `maintain_date`) USING BTREE
...
CREATE TABLE `system_address_count`  (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '全国主要城市表',
  `code_country` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'china' COMMENT '国家英文',
  ...
  `count_coun` int(11) NOT NULL DEFAULT 0 COMMENT '下级区县数量',
  `num_order` int(11) NOT NULL DEFAULT 0 COMMENT '发单量',
  `num_engineer` int(11) NOT NULL DEFAULT 0 COMMENT '发单量',
  `has_service_provider` smallint(11) NOT NULL DEFAULT 0 COMMENT '是否服务商',
  `created_unix` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间戳',
  `updated_unix` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `system_alarm_platform`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `platform_alarm_id` int(11) NOT NULL COMMENT '报警类型 平台统一',
...
CREATE TABLE `system_config`  (
  ...
  `is_encrypted` smallint(6) NOT NULL DEFAULT 0 COMMENT '0未加密  1加密',
  `remark` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `is_deleted` int(11) NOT NULL DEFAULT 0 COMMENT '删除标记',
  `created_unix` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间戳',
  `updated_unix` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `sytem_key`(`conf_key`) USING BTREE
...
CREATE TABLE `system_database`  (
  ...
  `last_backup_max_id` bigint(20) NOT NULL DEFAULT 0 COMMENT '最近备份的最大记录ID',
  ...
  `tactics` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '数据库管理策略，json对象',
  `remark` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '备注',
  `is_deleted` int(11) NOT NULL DEFAULT 0 COMMENT '删除位',
  ...
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `ix_table_name`(`database_name`, `table_name`, `is_deleted`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1276 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '定时清理/备份表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `system_dictionary`  (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '产品主表',
  ...
  `order_id` int(11) NULL DEFAULT 0 COMMENT '排序',
  `num_use` int(11) NOT NULL DEFAULT 0 COMMENT '累计使用次数',
  `created_unix` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间戳',
  `updated_unix` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `uk_value`(`dictionary_value`, `dictionary_type`) USING BTREE,
  UNIQUE INDEX `uk_key`(`dictionary_key`, `dictionary_type`) USING BTREE
...
CREATE TABLE `system_doc`  (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '系统文档',
  ...
  `likes_count` int(11) NOT NULL DEFAULT 0 COMMENT '赞数量',
  ...
  `is_deleted` int(11) NOT NULL DEFAULT 0 COMMENT '删除标记',
  `order_id` int(11) NOT NULL DEFAULT 100 COMMENT '排序字段',
  `created_unix` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间戳',
  `updated_unix` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `uk_url`(`doc_url`) USING BTREE
...
CREATE TABLE `system_domain`  (
  ...
  `advance_days` int(11) NOT NULL DEFAULT 15 COMMENT '提前多少天通知',
  ...
  `updated_unix` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `uk_domain`(`domain`, `port`) USING BTREE
...
CREATE TABLE `system_image_template`  (
  `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '照片模板要求DEMO，自增长ID',
  ...
  `updated_unix` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `uk_template`(`template_code`) USING BTREE
...
CREATE TABLE `system_mq`  (
  `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'MQ消息表',
  `content` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '消息内容',
  `state` smallint(6) UNSIGNED NOT NULL DEFAULT 0 COMMENT '状态：0-发送中，1-成功，2-失败',
  ...
  `try_count` smallint(5) UNSIGNED NULL DEFAULT NULL COMMENT '重试次数',
...
CREATE TABLE `system_msg_template`  (
  ...
  `template_type` smallint(6) NOT NULL DEFAULT 0 COMMENT '模板类型 0通用类型 10短信 20邮件 30极光推送',
  ...
  `updated_unix` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `uk_template`(`template_id`) USING BTREE
...
CREATE TABLE `system_nationality`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `idx_nation_code`(`nation_code`) USING BTREE
...
CREATE TABLE `system_notification`  (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '全部消息',
  ...
  `notify_group` smallint(6) NOT NULL DEFAULT 0 COMMENT '消息类型  0=默认，1=消息，2=通知, 3=待办',
  ...
  `created_unix` datetime NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_notification`(`user_id`, `organize_id`) USING BTREE
...
CREATE TABLE `system_open_platform`  (
  ...
  `app_secret` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '开发秘钥',
  `api_version` varchar(16) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT 'API版本号',
  `white_list` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT 'API请求白名单, | 分割',
  `minute_request_frequency` int(11) NULL DEFAULT 60 COMMENT '每分钟允许请求次数',
  `third_organize_code` varchar(16) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '第三方组织ID，方便回调',
  `remark` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '备注',
  `creator_id` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '创建者(发单者)',
  `creator_name` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '创建者(发单者)',
  ...
  `updated_unix` datetime NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_service`(`organize_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 27 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '开放平台开发者账号' ROW_FORMAT = Dynamic;
...
CREATE TABLE `system_repo`  (
  ...
  `num_doc` int(11) NOT NULL DEFAULT 0 COMMENT '共多少篇文档',
  `order_id` int(11) NOT NULL DEFAULT 0 COMMENT '排序字段',
  `is_public` smallint(6) NOT NULL DEFAULT 1 COMMENT '内部协议指引文档, 固定URL, 列表不可见',
  `is_deleted` int(11) NOT NULL DEFAULT 0 COMMENT '删除标记',
  `created_unix` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间戳',
  `updated_unix` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `sytem_repo_UN`(`repo_url`) USING BTREE
...
) ENGINE = InnoDB AUTO_INCREMENT = 15036 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '定时器分布式锁' ROW_FORMAT = Dynamic;
...
CREATE TABLE `system_trouble_knowledge`  (
  ...
  `main_category` smallint(6) NULL DEFAULT 0 COMMENT '主分类, 0=动力系统，1=车身系统，2=底盘系统，3=网络通讯系统',
  ...
  `updated_unix` datetime NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `idx_trouble_brand`(`trouble_code`, `vehicle_brand`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `system_version_app`  (
  ...
  `version_value` int(10) UNSIGNED NOT NULL DEFAULT 0 COMMENT '版本号',
  `lowest_version` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '允许最低版本(低于这个要强制更新)',
  `update_type` tinyint(3) NOT NULL DEFAULT 0 COMMENT '0：一般更新 1：强制更新',
  ...
  `updated_unix` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `uk_app`(`app_id`, `system_type`, `version_value`, `track`) USING BTREE
...
CREATE TABLE `user_alarm_linkage`  (
  ...
  `updated_unix` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `uk_alarm_linkage`(`organize_id`, `platform_alarm_id`, `user_id`) USING BTREE
...
CREATE TABLE `user_cmd`  (
  ...
  `updated_unix` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `uk_cmd`(`organize_id`, `user_id`, `cmd_protocol`, `cmd_key`) USING BTREE
...
CREATE TABLE `user_contact_address`  (
  ...
  `is_default` smallint(6) NOT NULL DEFAULT 0 COMMENT '是否默认地址',
  `created_unix` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间戳',
  `updated_unix` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `uk_name`(`user_id`, `contact_name`) USING BTREE
...
CREATE TABLE `user_engineer`  (
  `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '认证过的工程师',
  `user_id` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '用户ID',
  `account` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '账号',
  ...
  `is_automatic_order` smallint(6) NOT NULL DEFAULT 0 COMMENT '自动接单中 0不接单 1自动接单',
  ...
  `is_temporary` smallint(6) NOT NULL DEFAULT 0 COMMENT '临时工程师,不需要提交认证',
  `is_deleted` bigint(20) UNSIGNED NOT NULL DEFAULT 0 COMMENT '删除位',
  `created_unix` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间戳',
  `updated_unix` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `uk_id`(`user_id`, `is_deleted`) USING BTREE,
  UNIQUE INDEX `uk_card`(`identity_card`, `is_deleted`) USING BTREE
...
CREATE TABLE `user_engineer_authentication`  (
  `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '工程师认证请求',
  `user_id` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '用户ID',
  `full_name` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '姓名',
...
CREATE TABLE `user_favorite`  (
  `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '用户收藏或者自定义分组',
  `organize_id` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '组织ID',
  `user_id` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '创建用户',
  ...
  `updated_unix` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `uk_user_vehicle`(`organize_id`, `user_id`, `favorite_id`) USING BTREE,
  INDEX `idx_favorite`(`organize_id`, `favorite_id`) USING BTREE
...
CREATE TABLE `user_info`  (
  ...
  `account_modified` int(11) NOT NULL DEFAULT 0 COMMENT '初始账号被修改过次数',
  `is_prohibit_login` tinyint(1) NOT NULL DEFAULT 0 COMMENT '禁止登录',
  ...
  `create_origin` int(11) NULL DEFAULT NULL COMMENT '创建方式',
...
) ENGINE = InnoDB AUTO_INCREMENT = 15865 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '用户表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `user_issue`  (
  `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '用户收藏的组织或者个人工程师，自增长ID',
  `user_id` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '用户ID',
  ...
  `handle_status` smallint(6) NOT NULL DEFAULT 0 COMMENT '处理状态 0未处理 1忽略 2已处理',
  ...
  `updated_unix` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `uk_user_organize`(`user_id`) USING BTREE
...
CREATE TABLE `user_line_config`  (
  ...
  `is_active` int(11) NOT NULL DEFAULT 0 COMMENT '有效标识 0 无效 1 有效',
  `created_unix` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间戳',
  `updated_unix` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `user_line_config_user_id_IDX`(`user_id`, `line_token`) USING BTREE
...
CREATE TABLE `user_notification`  (
  ...
  `notification_value` int(11) NOT NULL DEFAULT 0 COMMENT '通知方式 bit1=消息 bit2=邮件 bit3=短信',
  `notification_app` int(11) NOT NULL DEFAULT 0 COMMENT 'APP通知 0不通知 1通知',
  `notification_web` int(11) NOT NULL DEFAULT 0 COMMENT 'WEB通知 0不通知 1通知',
  `notification_email` int(11) NOT NULL DEFAULT 0 COMMENT 'EMAIL通知 0不通知 1通知',
  `notification_sms` int(11) NOT NULL DEFAULT 0 COMMENT '短信通知 0不通知 1通知',
  `created_unix` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间戳',
  `updated_unix` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `idx_user`(`user_id`, `notification_key`) USING BTREE
...
CREATE TABLE `user_organize`  (
  ...
  `member_role_value` int(11) NOT NULL DEFAULT 1 COMMENT '成员身份值, 方便排序',
  `role_id` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '自定义角色ID',
  ...
  `expire_time` datetime NULL DEFAULT NULL COMMENT '到期时间',
  `tree_model` smallint(6) NOT NULL DEFAULT 0 COMMENT '0默认企业-车队-车辆树 1企业-车辆树 2企业-车辆上级车队-车辆树',
  `created_unix` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间戳',
  `updated_unix` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `uk_user_organize`(`user_id`, `organize_id`) USING BTREE,
  INDEX `idx_organize_id`(`organize_id`) USING BTREE,
...
CREATE TABLE `user_organize_apply`  (
  ...
  `apply_status` smallint(6) NOT NULL DEFAULT 0 COMMENT '申请单状态 = 0等待  1同意 2拒绝',
  `reject_reason` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `created_unix` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间戳',
  `updated_unix` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `uk_user_organize`(`organize_id`) USING BTREE
...
CREATE TABLE `user_organize_invite`  (
  ...
  `invite_user_choose` smallint(6) NOT NULL DEFAULT 0 COMMENT '被邀请者 = 0等待  1同意 2拒绝',
  ...
  `updated_unix` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `uk_user_organize`(`invite_user_id`, `organize_id`) USING BTREE
...
CREATE TABLE `user_subscribe_config`  (
  ...
  `is_enabled` int(11) NOT NULL DEFAULT 0 COMMENT '启用标识 0 禁用 1 启用',
  `lang` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'zh-CN' COMMENT '模板多言',
  `time_zone` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'zh-CN' COMMENT '时区',
  ...
  `updated_unix` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `user_subscribe_config_un`(`organize_id`, `user_id`, `channel_key`, `notify_pipe`) USING BTREE,
  INDEX `user_subscribe_config_organize_id_IDX`(`organize_id`, `channel_key`) USING BTREE,
  INDEX `user_subscribe_config_channel_key_IDX`(`channel_key`, `notify_pipe`) USING BTREE
...
CREATE TABLE `user_third_login`  (
  ...
  `third_party_type` int(11) NOT NULL DEFAULT 0 COMMENT '第三方登录类型 0账号密码 10手机短信 20邮箱 30微信 40line',
  `bind_flag` smallint(6) NOT NULL DEFAULT 0 COMMENT '0默认 1绑定 2解绑',
  `last_login_in_unix` timestamp NULL DEFAULT NULL COMMENT '最后登陆时间',
  `is_deleted` bigint(20) UNSIGNED NOT NULL DEFAULT 0 COMMENT '删除位',
  `created_unix` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间戳',
  `updated_unix` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `uk_unique_acount`(`third_unique_account`, `is_deleted`) USING BTREE,
  INDEX `idx_user_id`(`user_id`) USING BTREE
...
CREATE TABLE `user_vehicle`  (
  ...
  `updated_unix` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `uk_user_vehicle`(`organize_id`, `user_id`, `vehicle_id`) USING BTREE,
  INDEX `user_vehicle_organize_id_IDX`(`organize_id`, `vehicle_id`) USING BTREE
...
CREATE ALGORITHM = UNDEFINED SQL SECURITY DEFINER VIEW `view_organize_user` AS select `view_organize_user`.`id` AS `id`,`view_organize_user`.`organize_id` AS `organize_id`,`view_organize_user`.`user_id` AS `user_id`,`view_organize_user`.`user_name` AS `user_name`,`view_organize_user`.`nick_name` AS `nick_name`,`view_organize_user`.`account` AS `account`,`view_organize_user`.`custom_avatar` AS `custom_avatar`,`view_organize_user`.`full_name` AS `full_name`,`view_organize_user`.`creator_id` AS `creator_id`,`view_organize_user`.`expire_time` AS `expire_time`,`view_organize_user`.`member_role` AS `member_role`,`view_organize_user`.`member_role_value` AS `member_role_value`,`view_organize_user`.`role_id` AS `role_id`,`view_organize_user`.`tree_model` AS `tree_model`,`view_organize_user`.`choose` AS `choose` from (select `maintain`.`user_organize`.`id` AS `id`,`maintain`.`user_organize`.`organize_id` AS `organize_id`,`maintain`.`user_info`.`user_id` AS `user_id`,`maintain`.`user_info`.`user_name` AS `user_name`,`maintain`.`user_organize`.`nick_name` AS `nick_name`,`maintain`.`user_info`.`account` AS `account`,`maintain`.`user_info`.`custom_avatar` AS `custom_avatar`,`maintain`.`user_info`.`full_name` AS `full_name`,`maintain`.`user_info`.`creator_id` AS `creator_id`,`maintain`.`user_organize`.`expire_time` AS `expire_time`,`maintain`.`user_organize`.`member_role` AS `member_role`,`maintain`.`user_organize`.`member_role_value` AS `member_role_value`,`maintain`.`user_organize`.`role_id` AS `role_id`,`maintain`.`user_organize`.`tree_model` AS `tree_model`,1 AS `choose` from (`maintain`.`user_organize` join `maintain`.`user_info`) where ((`maintain`.`user_info`.`user_id` = `maintain`.`user_organize`.`user_id`) and (`maintain`.`user_info`.`is_deleted` = 0)) union all select -(`maintain`.`user_organize_invite`.`id`) AS `id`,`maintain`.`user_organize_invite`.`organize_id` AS `organize_id`,`maintain`.`user_organize_invite`.`invite_user_id` AS `user_id`,`maintain`.`user_info`.`user_name` AS `user_name`,`maintain`.`user_info`.`user_name` AS `nick_name`,`maintain`.`user_info`.`account` AS `account`,`maintain`.`user_info`.`custom_avatar` AS `custom_avatar`,`maintain`.`user_info`.`full_name` AS `full_name`,`maintain`.`user_info`.`creator_id` AS `creator_id`,NULL AS `expire_time`,`maintain`.`user_organize_invite`.`member_role` AS `member_role`,0 AS `member_role_value`,0 AS `tree_model`,'' AS `role_id`,`maintain`.`user_organize_invite`.`invite_user_choose` AS `choose` from (`maintain`.`user_organize_invite` join `maintain`.`user_info`) where ((`maintain`.`user_organize_invite`.`invite_user_choose` = 0) and (`maintain`.`user_info`.`user_id` = `maintain`.`user_organize_invite`.`invite_user_id`) and (`maintain`.`user_info`.`is_deleted` = 0))) `view_organize_user` order by `view_organize_user`.`member_role_value` desc;
